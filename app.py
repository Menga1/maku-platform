...
st.set_page_config(page_title="MAKU - Kinetic Risk Assessment", page_icon="🏗️", layout="wide")

# ---------------------------------------------------------------------------
# Sidebar - language selector persists (via session_state) across every page
# ---------------------------------------------------------------------------
