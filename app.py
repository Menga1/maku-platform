...
from ai_advisor import (
    get_controls, generate_narrative_cached,
...
from analytics import log_assessment, log_site_alert, get_site_alert_log_dataframe
...
def render_ai_narrative(
    ...
    """Single entry point every module page uses to display its AI action
    plan. Honest design note: this does NOT try to stream AND cache the
...
def render_dashboard():
    ...
    alert_log = get_site_alert_log_dataframe()
