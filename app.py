...
pg = st.navigation([
    ...
    st.Page(render_solar_farms, title="Solar Farms", icon="☀️"),
    st.Page(render_offshore_oil_gas, title="Offshore Oil & Gas", icon="🌊"),
    st.Page(render_metros_tunnels, title="Metros & Tunnels", icon="🚇"),
    st.Page(render_high_rise, title="High Rise", icon="🏗️"),
    st.Page(render_data_centers, title="Data Centers", icon="🏢"),
])
pg.run()
