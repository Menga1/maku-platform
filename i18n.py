...
STRINGS = {
    ...
    "env_inputs_note": {
        "fr": "Note MVP : les données environnementales ci-dessous sont saisies "
              "manuellement pour simuler des flux satellite, bouées et capteurs "
              "souterrains en temps réel.",
        "en": "MVP note: environmental inputs below are entered manually to simulate "
              "live satellite, buoy, and subsurface sensor feeds.",
    },
