...
STRINGS = {
    ...
    "nav_header": {"fr": "Navigation des modules", "en": "Module navigation"},
    "nav_dashboard": {"fr": "🛡️ Tableau de bord", "en": "🛡️ Dashboard"},
    "nav_solar": {"fr": "☀️ Fermes solaires", "en": "☀️ Solar Farms"},
    "nav_offshore": {"fr": "🌊 Offshore Pétrole & Gaz", "en": "🌊 Offshore Oil & Gas"},
    "nav_metros": {"fr": "🚇 Métros & Tunnels", "en": "🚇 Metros & Tunnels"},
    "nav_highrise": {"fr": "🏙️ Tours (Gratte-ciel)", "en": "🏙️ High-Rise"},
    "nav_datacenter": {"fr": "🖥️ Data Centers", "en": "🖥️ Data Centers"},
